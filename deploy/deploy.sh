...
function get_vars() {
    ...
    readonly PROFILES_MANAGER_RPC_ADDR=`consul kv get -http-addr=${CONSUL_ADDR} config/${ENV}/services/${CHART_NAME}/vars/profileManagerRpcAddr`
...
function deploy() {
    ...
    helm upgrade \
        ...
        --set config.profileManagerRpcAddr="${PROFILES_MANAGER_RPC_ADDR}" \
